...
public interface ITradiTexHBiTexOrderRMi {
	...
	// #### symbols
	// 查询交易对
	@RequestMapping(value = "/symbols", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public R<List<String>> symbols(@RequestParam("connid") String connid, @RequestParam("resthost") String resthost);

	// #### symbols
	// 查询交易对
	@RequestMapping(value = "/symbol/get", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	public R<HBiTexHttpResult<String>> create(@RequestParam("connid") String connid,
			@RequestParam("client-order-id") String clientOrderId, @RequestParam("order-type") String orderType,
			@RequestParam("symbol") String symbol, @RequestParam(value = "price", required = false) String price, // 市价单无价格
			@RequestParam("amount") String amount, @RequestParam("side") String side, // BUY or SELL
	...
	public R<List<HBiTexOrderDetails>> orders(@RequestParam("connid") String connid,
			@RequestParam("resthost") String resthost, @RequestParam("symbol") String symbol,
	...
	public R<HBiTexOrderDetails> queryOrder(@RequestParam("connid") String connid,
			@RequestParam("resthost") String resthost, @RequestParam("client-order-id") String clientOrderId);

	// #### order
	// 查询订单撮合详情
	@RequestMapping(value = "/matchs", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	public R<?> cancelOrder(@RequestParam("connid") String connid, @RequestParam("resthost") String resthost,
