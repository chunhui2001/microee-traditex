...
public interface ITradiTexConnectorRMi {
	...
	public R<Set<String>> destroy(@RequestParam("connid") String connid, @RequestParam("ONE_TIME_PASSWORD") String otp);
	...
	public R<String> b2c2OrderBookNew(@RequestParam("connid") String connid, @RequestParam("wsHost") String wsHost,
			@RequestParam("restHost") String restHost, @RequestParam("accessToken") String accessToken,
	...
	public R<String> jumpTradingOrderBookNew(@RequestParam("connid") String connid,
			@RequestParam("streamHost") String streamHost, @RequestParam("apiKey") String apiKey,
	...
	public R<String> cumberlandOrderBookNew(@RequestParam("connid") String connid,
			@RequestParam("cbHost") String cbHost, @RequestParam("counterPartyId") String counterPartyId,
			@RequestParam("userId") String userId, @RequestParam("sslfile") MultipartFile sslfile,
	...
	public R<String> hbitexOrderBookNew(@RequestHeader("connid") String connid,
	...
	public R<String> hbitexKLineNew(@RequestHeader("connid") String connid,
			@RequestHeader("exchangeCode") String exchangeCode,
			@RequestHeader(value = "proxy-address", required = false) String proxyAddr,
			@RequestHeader(value = "proxy-port", required = false) Integer proxyPost,
			@RequestParam("wshost") String wshost);
	...
	public R<String> hbitexKLineSub(@RequestHeader("connid") String connid, @RequestParam("symbol") String symbol,
	...
	public R<Boolean> hbitexOrderBookSub(@RequestHeader("connid") String connid, @RequestParam("step") String step,
	...
	public R<Boolean> hbitexOrderBookUnsub(@RequestHeader("connid") String connid, @RequestParam("step") String step,
			@RequestParam("symbol") String symbol);

	// ### 取消订阅资产或订单状态变动
	@RequestMapping(value = "/hbitex/orderbalance/unsub", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public R<Boolean> hbitexOrderBalanceUnsub(@RequestHeader("connid") String connid,
	...
	public R<String> hbitexOrderBalanceNew(@RequestHeader("connid") String connid,
			@RequestHeader("exchangeCode") String exchangeCode, @RequestHeader("uid") String uid,
	...
	public R<String> hbitexOrderBalanceLogin(@RequestHeader("connid") String connid, @RequestHeader("uid") String uid,
			@RequestHeader("accessKey") String accessKey, @RequestHeader("secretKey") String secretKey,
	...
	public R<Boolean> hbitexOrderSubscribe(@RequestHeader("connid") String connid,
			@RequestParam("symbol") String symbol);
	...
	public R<String> oandaPricingStreamSetup(@RequestParam("stream-host") String streamHost,
			...
			@RequestParam("access-token") String accessToken, @RequestParam("instruments") String[] instruments,
			@RequestParam(value = "proxy-address", required = false) String proxyAddress,
			@RequestParam(value = "proxy-port", required = false) Integer proxyPost);
